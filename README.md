...
screen, judges PASS/FAIL from the pixels, and records the verdict. `git push` is
blocked until a fresh PASS exists for the commit; `--no-verify` is the only bypass.
